export const servicePolicyData = [
  {
  ...
  },
  {
    ...
    contents: [
      ...
      '1. 회원 가입 및 관리\n • 필수항목 : 아이디, 비밀번호, 이메일주소, 휴대폰번호, 생년월일(사용자 입력값)\n • 선택항목 : 인증 후 취득정보(이름, 성별, 생년월일, 개인식별고유키, 휴대폰번호, 통신사, 외국인여부), 연락처 목록\n• 소셜 인증을 통한 회원 가입 시, 인증 서비스 제공자로부터 제공받은 정보(이름, 이메일 주소, 프로필 사진 등)가 자동으로 수집될 수 있습니다.',
      '2. 재화 또는 서비스 제공\n • 필수항목 : 촬영정보(촬영일, 촬영시간, 촬영사진/촬영영상, 촬영된 콘텐츠의 메타값)\n • 선택항목 : 위치정보, 성인여부',
      '3. 앱 이용 과정에서 아래와 같은 개인정보 항목이 자동으로 수집될 수 있습니다.\n • IP주소, 디바이스 정보, 서비스 이용 기록, 방문 기록, 불량 이용 기록 등',
    ],
  },
  {
    title: '제7조(개인정보의 파기)',
  ...
  },
  {
    ...
    contents: [
      ...
      '▶ 개인정보 보호 담당부서\n부서명 : 운영진\n담당자 : 이민혁, 최현아, 권채은\n연락처 : E. teamfromnow@gmail.com',
      '② 정보주체께서는 회사의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 회사는 정보주체의 문의에 대해 지체없이 답변 및 처리해드릴 것 입니다.',
    ],
  },
  {
  ...
  },
  {
    ...
    contents: [
      '정보주체는 아래의 기관에 대해 개인정보 침해에 대한 피해 구제, 상담 등을 문의하실 수 있습니다.\n<아래의 기관은 회사와는 별개의 기관으로서, 회사의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나 보다 자세한 도움이 필요하시면 문의하여 주시기 바랍니다.>',
