...
const Badge = ({ title, removeOne }: Props) => {
  return (
    <View className="border-black200 border-[1px] px-3 h-[32px] rounded-2xl flex flex-row justify-center items-center bg-black100 mr-[7px] mt-[7px]">
