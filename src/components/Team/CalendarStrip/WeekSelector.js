...
class WeekSelector extends Component {
  ...
  render() {
    const { controlDate, iconContainerStyle, iconComponent, iconInstanceStyle, iconStyle, imageSource, onPress, weekEndDate, weekStartDate, size } =
      this.props;
    ...
    if (React.isValidElement(iconComponent)) {
      ...
      component = <Image style={[styles.icon, imageSize, iconStyle, iconInstanceStyle, opacity]} source={imageSource} />;
    }
