...
class CalendarStrip extends Component {
  ...
  onLayoutDebounce = layout => {
    const { numDaysInWeek, responsiveSizingOffset, maxDayComponentSize, minDayComponentSize, showMonth, showDate, scrollable, dayComponentHeight } =
      this.props;
  ...
  renderHeader() {
    return (
      this.props.showMonth && (
        <CalendarHeader
          controlDateLeft={this.props.minDate}
          controlDateRight={this.props.maxDate}
          onLeftPress={this.getPreviousWeek}
          onRightPress={this.getNextWeek}
